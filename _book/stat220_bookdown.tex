...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{multi\_kmeans }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{k =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{15}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}
    \AttributeTok{model =}\NormalTok{ purrr}\SpecialCharTok{::}\FunctionTok{map}\NormalTok{(k, }\SpecialCharTok{\textasciitilde{}} \FunctionTok{kmeans}\NormalTok{(my\_df, }\AttributeTok{centers =}\NormalTok{ .x, }\AttributeTok{nstart =} \DecValTok{25}\NormalTok{)),}
    \AttributeTok{tot.withinss =}\NormalTok{ purrr}\SpecialCharTok{::}\FunctionTok{map\_dbl}\NormalTok{(model, }\SpecialCharTok{\textasciitilde{}} \FunctionTok{glance}\NormalTok{(.x)}\SpecialCharTok{$}\NormalTok{tot.withinss)}
\NormalTok{  )}
...
\includegraphics[width=1\linewidth]{class_activity_25_files/figure-latex/unnamed-chunk-17-1}
...
\includegraphics[width=1\linewidth]{class_activity_27_files/figure-latex/unnamed-chunk-12-1}
...
\includegraphics[width=1\linewidth]{class_activity_27_files/figure-latex/unnamed-chunk-13-1}
...
\includegraphics[width=1\linewidth]{class_activity_27_files/figure-latex/unnamed-chunk-20-1}
