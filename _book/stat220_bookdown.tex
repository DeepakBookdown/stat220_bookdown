...
\CommentTok{\# make a new repo in remote Github}

\CommentTok{\# usethis::use\_git()}
\CommentTok{\# usethis::use\_github()}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{tutorial-1-creating-a-new-github-repository-using-usethis-r-package}{%
\section{\texorpdfstring{Tutorial 1: Creating a new GitHub repository using \texttt{usethis} R package}{Tutorial 1: Creating a new GitHub repository using usethis R package}}\label{tutorial-1-creating-a-new-github-repository-using-usethis-r-package}}
...
\hypertarget{tutorial-2-cloning-the-github-repository-back-to-your-local-machine}{%
\section{Tutorial 2: Cloning the GitHub repository back to your local machine}\label{tutorial-2-cloning-the-github-repository-back-to-your-local-machine}}
...
\item
  Now, you have successfully cloned your GitHub repository to your local machine. You can make changes to the files and push back the changes regularly.
\end{enumerate}
