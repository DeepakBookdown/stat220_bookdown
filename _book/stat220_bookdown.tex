...
# A tibble: 24 x 5
   ...
   <int> <chr> <chr>         <dbl> <fct>    
 1     2 9th   Africa           51 9th      
 2     3 9th   Africa           57 9th      
 3     6 9th   Asia             50 9th      
 4     8 9th   Africa           70 9th      
 5    10 9th   Europe           59 9th      
 6    12 9th   Asia             74 9th      
 7    13 9th   North America    76 9th      
 8    14 9th   Europe          100 9th      
 9    17 9th   North America    86 9th      
10    20 9th   South America    69 9th      
11    24 9th   Asia             92 9th      
12     1 10th  Asia             75 10th     
13     4 10th  Middle East      85 10th     
14     5 10th  Africa           77 10th     
15     9 10th  Asia             82 10th     
16    11 10th  Europe           53 10th     
17    15 10th  North America    99 10th     
18    19 10th  Africa           97 10th     
19    23 10th  Asia             89 10th     
20     7 11th  Europe           53 11th     
21    16 11th  Asia             84 11th     
22    18 11th  Asia             55 11th     
23    21 11th  Europe           86 11th     
24    22 11th  South America    91 11th     
\end{verbatim}
...
\NormalTok{  janitor}\SpecialCharTok{::}\FunctionTok{clean\_names}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate\_at}\NormalTok{(}\DecValTok{2}\SpecialCharTok{:}\DecValTok{4}\NormalTok{, parse\_number) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{state =} \FunctionTok{str\_to\_lower}\NormalTok{(state)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(state }\SpecialCharTok{\%in\%} \FunctionTok{setdiff}\NormalTok{(state, }\FunctionTok{c}\NormalTok{(}\StringTok{"hawaii"}\NormalTok{, }\StringTok{"alaska"}\NormalTok{)))}

\NormalTok{all\_states }\OtherTok{\textless{}{-}}\NormalTok{ covid\_final}\SpecialCharTok{$}\NormalTok{state }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{unique}\NormalTok{()}

\NormalTok{USA\_all }\OtherTok{\textless{}{-}}\NormalTok{ maps}\SpecialCharTok{::}\FunctionTok{map}\NormalTok{(}\StringTok{"state"}\NormalTok{ , }
                         \AttributeTok{plot =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{fill =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{map2SpatialPolygons}\NormalTok{(}\AttributeTok{IDs =} \FunctionTok{str\_remove}\NormalTok{(.}\SpecialCharTok{$}\NormalTok{names, }\StringTok{"(?=:).+"}\NormalTok{))}

\NormalTok{map }\OtherTok{\textless{}{-}} \FunctionTok{SpatialPolygonsDataFrame}\NormalTok{(USA\_all, covid\_final, }\AttributeTok{match.ID =} \ConstantTok{FALSE}\NormalTok{)}
...
\hypertarget{q8.-deploying-a-shiny-app-to-shinyapps.io}{%
\subsection{\texorpdfstring{Q8. Deploying a Shiny App to \texttt{shinyapps.io}}{Q8. Deploying a Shiny App to shinyapps.io}}\label{q8.-deploying-a-shiny-app-to-shinyapps.io}}

Open an account on \href{https://www.shinyapps.io/admin/\#/dashboard}{shinyapps.io} and follow the steps to deploy one of the apps to \href{https://www.shinyapps.io/admin/\#/dashboard}{shinyapps.io}.
...
\includegraphics[width=1\linewidth]{class_activity_21_files/figure-latex/unnamed-chunk-3-1}
...
1        23 accuracy binary     0.751    10  0.0301 Preproc~
2        24 accuracy binary     0.751    10  0.0301 Preproc~
3        17 ppv      binary     0.783    10  0.0225 Preproc~
4        18 ppv      binary     0.783    10  0.0225 Preproc~
5        37 sens     binary     0.891    10  0.0310 Preproc~
6        38 sens     binary     0.891    10  0.0310 Preproc~
7        17 spec     binary     0.5      10  0.0562 Preproc~
8        18 spec     binary     0.5      10  0.0562 Preproc~
\end{verbatim}
...
\includegraphics[width=1\linewidth]{class_activity_25_files/figure-latex/unnamed-chunk-2-1}
...
\includegraphics[width=1\linewidth]{class_activity_25_files/figure-latex/unnamed-chunk-4-1}
...
\includegraphics[width=1\linewidth]{class_activity_25_files/figure-latex/unnamed-chunk-6-1}
...
\includegraphics[width=1\linewidth]{class_activity_25_files/figure-latex/unnamed-chunk-8-1}
...
\includegraphics[width=1\linewidth]{class_activity_25_files/figure-latex/unnamed-chunk-10-1}
