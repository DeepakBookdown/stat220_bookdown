...
\item
  If you haven't done so already, accept the invite to the class organization \href{https://github.com/DataScienceSpring23}{DataScienceSpring23}. This organization is where all course homework, activity files, and project repositories will live.
\item
...
In this worksheet, you will practice creating a GitHub repository using the RStudio Git terminal, usethis::use\_github() function and cloning it back to your local machine using RStudio's menu options.

\hypertarget{tutorial-1-creating-a-new-github-repository-using-rstudios-git-terminal}{%
\section{Tutorial 1: Creating a new GitHub repository using RStudio's Git terminal}\label{tutorial-1-creating-a-new-github-repository-using-rstudios-git-terminal}}
...
\hypertarget{tutorial-2-cloning-the-github-repository}{%
\section{Tutorial 2: Cloning the GitHub repository}\label{tutorial-2-cloning-the-github-repository}}
...
\hypertarget{creating-a-new-github-repository}{%
\subsection{Creating a new GitHub repository}\label{creating-a-new-github-repository}}
...
\hypertarget{tutorial-3-cloning-the-github-repository}{%
\section{Tutorial 3: Cloning the GitHub repository}\label{tutorial-3-cloning-the-github-repository}}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  To clone the repository to another folder on your local machine, first, close the current RStudio project by clicking on ``File'' \textgreater{} ``Close Project.''
\item
  Next, create a new R project in RStudio by clicking on ``File'' \textgreater{} ``New Project'' \textgreater{} ``Version Control'' \textgreater{} ``Git.''
\item
  In the ``Repository URL'' field, paste the URL of the GitHub repository you created in Activity 1. Choose a location on your computer to save the cloned project, and click ``Create Project.''
\item
  Now, you have successfully cloned your GitHub repository to your local machine. You can make changes to the files
\end{enumerate}

\hypertarget{tutorial-4-creating-a-new-github-repository-using-rstudios-git-terminal}{%
\section{Tutorial 4: Creating a new GitHub repository using RStudio's Git terminal}\label{tutorial-4-creating-a-new-github-repository-using-rstudios-git-terminal}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{git config user.name }\StringTok{"Your Name"}
\NormalTok{git config user.email }\StringTok{"youremail@example.com"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{git add .}
\NormalTok{git commit }\SpecialCharTok{{-}}\NormalTok{m }\StringTok{"Initial commit"}
\end{Highlighting}
\end{Shaded}
...
\item
  In the ``\ldots or push an existing repository from the command line'' section of your new GitHub repository, copy
\end{enumerate}
