...
# A tibble: 24 x 5
   ...
   <int> <chr> <chr>         <dbl> <fct>    
 1     2 9th   Africa           50 9th      
 2     5 9th   Europe           60 9th      
 3     6 9th   Africa           93 9th      
 4    10 9th   South America    51 9th      
 5    11 9th   North America    98 9th      
 6    14 9th   North America    96 9th      
 7    15 9th   North America    51 9th      
 8    21 9th   North America    88 9th      
 9    24 9th   Africa           62 9th      
10     4 10th  Middle East      60 10th     
11     7 10th  Europe           89 10th     
12    16 10th  Europe           66 10th     
13    20 10th  North America    89 10th     
14    23 10th  Europe           65 10th     
15     1 11th  Middle East      76 11th     
16     3 11th  Asia             62 11th     
17     8 11th  Africa           98 11th     
18     9 11th  Africa           59 11th     
19    12 11th  Africa           75 11th     
20    13 11th  Europe           73 11th     
21    17 11th  Europe           89 11th     
22    18 11th  Asia             77 11th     
23    19 11th  Asia             79 11th     
24    22 11th  Africa           57 11th     
\end{verbatim}
...
# Groups:   .metric [4]
 ...
 1        29 accuracy binary     0.748    10  0.0185 Prepro~
 2        30 accuracy binary     0.748    10  0.0185 Prepro~
 3         7 ppv      binary     0.782    10  0.0179 Prepro~
 4         8 ppv      binary     0.782    10  0.0179 Prepro~
 5        25 sens     binary     0.876    10  0.0203 Prepro~
 6        26 sens     binary     0.876    10  0.0203 Prepro~
 7        29 sens     binary     0.876    10  0.0177 Prepro~
 8        30 sens     binary     0.876    10  0.0177 Prepro~
 9        31 sens     binary     0.876    10  0.0190 Prepro~
10        32 sens     binary     0.876    10  0.0190 Prepro~
11        35 sens     binary     0.876    10  0.0190 Prepro~
12        36 sens     binary     0.876    10  0.0190 Prepro~
13        37 sens     binary     0.876    10  0.0190 Prepro~
14        38 sens     binary     0.876    10  0.0190 Prepro~
15        39 sens     binary     0.876    10  0.0177 Prepro~
16        40 sens     binary     0.876    10  0.0177 Prepro~
17         7 spec     binary     0.524    10  0.0455 Prepro~
18         8 spec     binary     0.524    10  0.0455 Prepro~
\end{verbatim}
...
\NormalTok{  correct\_components }\OtherTok{\textless{}{-}} \FunctionTok{str\_split}\NormalTok{(correct\_address, }\StringTok{",}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{s*"}\NormalTok{)[[}\DecValTok{1}\NormalTok{]]}
  ...
  \CommentTok{\# Extract specific components}
...
\NormalTok{  zip\_code }\OtherTok{\textless{}{-}} \FunctionTok{str\_extract}\NormalTok{(address, }\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{d+"}\NormalTok{)}
...
\NormalTok{  state\_code }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(state }\SpecialCharTok{==} \StringTok{"MN"}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
...
\NormalTok{  zip\_code\_correctness }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(zip\_code }\SpecialCharTok{==} \StringTok{"55057"}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
